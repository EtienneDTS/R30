        ...
        <div className={style.navBar}>
            <ul>
                ...
                <li className={style.linkBox} onClick={() => { clickOnHandler("parchmentID") }}>
                    <div>
                        {
                            user ? (<Image className={style.image} width={60} height={60} src={user.image ? user.image : "/helmet.png"} alt={"Image de l'utilisateur"} />)
                ...
                <li className={style.options} id="parchmentID" >
                    <div className={style.parchment}>
                        ...
                        <div onMouseEnter={() => { onMouseEnterHandler("element2") }} onMouseLeave={() => onMouseLeaverHandler("element2")}><div id="element2" style={{ visibility: 'hidden' }}><Image className={style.blade} width={40} height={40} src={"/blade.svg"} alt={"selecteur"} /></div><p>Mes routine</p></div>

                        <div onMouseEnter={() => { onMouseEnterHandler("element3") }} onMouseLeave={() => onMouseLeaverHandler("element3")}><div id="element3" style={{ visibility: 'hidden' }}><Image className={style.blade} width={40} height={40} src={"/blade.svg"} alt={"selecteur"} /></div><p>Remplir fiche du jour</p></div>
